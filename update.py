...
def start_download():
    ...
    download_url = f"https://github.moeyy.xyz/https://github.com/himesamanoyume/Auto_Simulated_Universe/releases/download/{info['tag_name']}/Auto_Simulated_Universe_{info['tag_name']}.zip"
